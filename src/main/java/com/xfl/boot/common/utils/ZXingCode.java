...
/**
 * Created by XFL
 * time on 2018/5/9 22:25
 * description:二维码生成工具
 * https://blog.csdn.net/u013142781/article/details/50310419
 */
public class ZXingCode {
    ...
    public static void main(String[] args) {
        try {
            getLogoQRCode("https://c.zhongan.com/bd?business_id=10002539391010&agent_user_code=B81994437639&utm_source=agent&bizContent=7s4urmRH04itxO%2BXqjzccDZ2PY4hsw7iw%2Br1C9j2gFrLYvkQWmkhMTYZKpf7BibeTO%2FHRdS2DaCR3lroNVUIQZqa2rvlsDsDYAOLyGq%2BcyjwFQnZtTMVmIpQhcntkXMK5Bfm%2BR%2FGLyMsDgJTYCFPvlDWmOwsr6XL9Qa%2FfcZ9J2c%3D", "吴妙霞");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
//      String filePath = (javax.servlet.http.HttpServletRequest)request.getSession().getServletContext().getRealPath("/") + "resources/images/logoImages/llhlogo.png";
        ...
        String filePath = "C:\\Users\\XFL\\Desktop\\baoko.png";  //TODO
        String content = qrUrl;
        try {
            ZXingCode zp = new ZXingCode();
            BufferedImage bim = zp.getQR_CODEBufferedImage(content, BarcodeFormat.QR_CODE, 350, 350, zp.getDecodeHintType());
...
//            g.drawRect(x, y, widthLogo, heightLogo);
            ...
            if (productName != null && !productName.equals("")) {
                ...
                BufferedImage outImage = new BufferedImage(350, 350, BufferedImage.TYPE_4BYTE_ABGR);
...
//                  outg.drawString(productName, 0, image.getHeight() + (outImage.getHeight() - image.getHeight())/2 + 5 ); //画文字
                    ...
                    outg.drawString(productName, 180 - strWidth / 2, image.getHeight() + (outImage.getHeight() - image.getHeight()) / 2 - 15); //画文字
                }
                outg.dispose();
                outImage.flush();
                image = outImage;
            ...
            ImageIO.write(image, "png", new File("C:\\Users\\XFL\\Desktop\\" + "test.png")); //TODO
